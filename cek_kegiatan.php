			...
			<div class="container">
				...
				<?php
					$result		= mysqli_query($conn,"SELECT nama_wisata.nama AS nama_wisata, pelanggan.`id_pelanggan`, pelanggan.`id_pelanggan`, pelanggan.`nama` AS nama_pelanggan, pelanggan.`telpon`,
								...
								WHERE pembayaran.status_kegiatan='Belum' AND pembayaran.status_pembayaran='Success' AND pembayaran.acc_tourguide='Yes' AND pembayaran.bukti_kegiatan IS NOT NULL
								GROUP BY paketwisata.no_paketwisata;");
					while($row = mysqli_fetch_array($result)){
						echo "
								<div class='col-md-12 mb-2 mt-2'>
									<div class='card pl-2 pr-2 pt-2'>
										<form id='pilihan".$row['id_pembayaran']."' method='POST' action='cek_kegiatan_detail.php'>
