			...
			<div class="container">
				...
				<?php
					$result		= mysqli_query($conn,"SELECT nama_wisata.nama AS nama_wisata, nama_wisata.gambar, nama_wisata.deskripsi,
								...
								WHERE pemesanan.id_pelanggan=$idpengguna GROUP BY paketwisata.no_paketwisata;");
						...
						echo "	<div class='col-md-4 mb-2 mt-2'>
								...
								<div class='col-md-8 mb-2 mt-2'>
									<div class='card pl-2 pr-2 pt-2'>
										<form id='pilihan".$row['id_pembayaran']."' method='POST' action='riwayat_pengguna_detail.php'>
