...
<html>
	...
	<body>
		...
		<div class="jumbotron bg-primary text-white mb-4 mt-2">
			<div class="container">
				<h1><b>WisataSyS | Riwayat Pesanan Masuk</b></h1>
		...
		<div class="jumbotron bg-light">
			<div class="container">
				...
				<div class="row">
				<?php
					$result		= mysqli_query($conn,"SELECT nama_wisata.nama AS nama_wisata, nama_wisata.gambar, nama_wisata.deskripsi,
								...
								WHERE paketwisata.id_tourguide=$idpengguna AND pembayaran.status_pembayaran='Success' AND pembayaran.acc_tourguide<>'Pending'
								GROUP BY paketwisata.no_paketwisata;");
					while($row = mysqli_fetch_array($result)){
						echo "	<div class='col-md-4 mb-2 mt-2'>
									<div class='card pl-2 pr-2 pt-2 pb-2'>
										<img src='".$row['gambar']."' height='200px' width='100%'>
									</div>
								</div>
								<div class='col-md-8 mb-2 mt-2'>
									<div class='card pl-2 pr-2 pt-2'>
										<form id='pesanpilihan".$row['id_pembayaran']."' method='POST' action='riwayat_tourguide_detail.php'>
										...
										<input type='hidden' name='pilihandetailpesan' value='".$row['id_pembayaran']."'>
					...
					$result		= mysqli_query($conn,"SELECT nama_wisata.nama AS nama_wisata, nama_wisata.gambar, nama_wisata.deskripsi,
								...
								INNER JOIN nama_wisata ON nama_wisata.id_nama_wisata=paketwisata.id_nama_wisata
								INNER JOIN travel ON travel.id_travel=paketwisata.id_travel
								WHERE paketwisata.id_tourguide IS NULL AND pembayaran.status_pembayaran='Success' AND pembayaran.acc_tourguide<>'Pending'
								GROUP BY paketwisata.no_paketwisata;");
					while($row = mysqli_fetch_array($result)){
						echo "	<div class='col-md-4 mb-2 mt-2'>
									<div class='card pl-2 pr-2 pt-2 pb-2'>
