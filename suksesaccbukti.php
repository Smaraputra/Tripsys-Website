<?php
	...
	$result5	= mysqli_query($conn,"UPDATE pembayaran SET status_kegiatan='$statusacc' WHERE id_pembayaran=$idpembayaran ");
?>
<html>
	<head>
		<meta charset="utf-8">
		...
		<div class="jumbotron bg-light">
			<div class="container">
				...
				echo "<div id='tampilkonfirmasipilihanpaket' class='mb-2'>
						<h3 class='text-center'>Bukti Kegiatan dengan ID Pembayaran $idpembayaran Telah Dikonfirmasi</h3>
						</div>";
				?>
			</div>
		</div>
