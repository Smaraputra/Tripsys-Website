<?php
	...
	$result5	= mysqli_query($conn,"UPDATE pembayaran SET bukti_kegiatan='$buktibayar' WHERE id_pembayaran=$idpembayaran ");
?>
<html>
	<head>
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="jumbotron bg-primary text-white mb-4 mt-2">
			<div class="container">
				<h1><b>WisataSyS | Upload Bukti Kegiatan</b></h1>
				<p class="lead"><b>Kirimkan bukti pelaksanaan kegiatan anda.</b></p>
		...
		<div class="jumbotron bg-light">
			<div class="container">
				...
				echo "<div id='tampilkonfirmasipilihanpaket' class='mb-2'>
						<h3 class='text-center'>Bukti Kegiatan dengan ID Pembayaran $idpembayaran Telah Dikirimkan</h3>
						</div>";
				?>
			</div>
		</div>
