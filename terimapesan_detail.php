...
<html>
	...
	<body>
		...
		<div class="jumbotron bg-primary text-white mb-4 mt-2">
			<div class="container">
				<h1><b>WisataSyS | Detail Pemesanan Paket</b></h1>
				<p class="lead"><b>Cek detail pesanan yang masuk ke travel anda.</b></p>
				<a class="text-white" href="terimapesan.php"><b><-- Kembali</b></a>
			</div>
		</div>
		...
		<div class="jumbotron bg-light">
			<div class="container">
				...
				echo "<div id='tampilkonfirmasipilihanpaket' class='mb-2'>
						<h3 class='text-center'>Cek Detail Pesanan</h3>
						</div>";
				?>
				<div class="row">
				<?php
					...
					$result5	= mysqli_query($conn,"SELECT nama_wisata.nama AS nama_wisata, pelanggan.`id_pelanggan`, pelanggan.`id_pelanggan`, pelanggan.`nama` AS nama_pelanggan, pelanggan.`telpon`,
								...
								AND pembayaran.acc_tourguide='Pending' AND id_pembayaran=$idpembayaran
					...
					while($row = mysqli_fetch_array($result)){
						...
						while($row5 = mysqli_fetch_array($result5)){
							echo "							<br>
															<form method='POST' action='suksesterimapesan.php'>
															...
															<select id='pilacc' name='statusacc' class='form-control'>
																<option value='' class='inputform1' selected='true' disabled='disabled'>---Terima/Tolak---</option>
																<option value='Yes' class='inputform1' selected='true'>Terima</option>
																<option value='No' class='inputform1' selected='true'>Tolak</option>
															</select>
															<br>
															<input type='submit' id='acc' value='Kirim Status'>
															</form>
													";
						}
						echo "						</div>
